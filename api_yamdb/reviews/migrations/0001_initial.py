# Generated by Django 3.2 on 2023-03-23 11:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(help_text='Укажите год создания произведения', validators=[api.validators.validate_year], verbose_name='Год создания')),
                ...
                ('genre', models.ManyToManyField(help_text='Выберите жанр', to='reviews.Genre', verbose_name='Жанр')),
            ],
        ),
    ]
