    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(help_text='Укажите год создания произведения', validators=[users.validators.validate_year], verbose_name='Год создания')),
                ('name', models.CharField(help_text='Введите название произведения', max_length=256, verbose_name='Произведение')),
                ('category', models.ForeignKey(help_text='Выберите категорию', null=True, on_delete=django.db.models.deletion.SET_NULL, to='review.category', verbose_name='Категория')),
                ('genre', models.ManyToManyField(help_text='Выберите жанр', to='review.Genre', verbose_name='Жанр')),
            ],
        ),
    ]
